...
<div class="container-fluid">
  <div class="fade-in">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h4>{{ trans('wine.edit') }}</h4></div>
            <div class="card-body">
                ...
                <form action="{{ route('menu.update') }}" method="POST">
                    ...
                    <button class="btn btn-primary" type="submit">{{ trans('wine.update') }}</button>
                    <a class="btn btn-primary" href="{{ route('menu.index', ['menu' => $menuElement->menu_id]) }}">{{ trans('wine.return') }}</a>
                </form>
            </div>
          </div>
        </div>
