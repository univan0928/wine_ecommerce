...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/brand/coreui-base-white.png') }}" width="118" height="" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/brand/coreui-signet-white.svg') }}" width="118" height="46" alt="CoreUI Logo">
        </div>
        <ul class="c-sidebar-nav">
        @if(isset($appMenus['サイドバーメニュー']))
            @foreach($appMenus['サイドバーメニュー'] as $menuel)
                @if($menuel['slug'] === 'link')
