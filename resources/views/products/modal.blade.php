...
<div class = "d-flex justify-content-between">
    <div>
        <select class = "form-control" onchange ="loadDataStart()" id = "count", name = "count">
            @if(isset($result['countlimit']) && $result['countlimit'] == 10)
                <option value = "10" selected>10</option>
            @else
                <option value = "10">10</option>
            @endif
            @if(isset($result['countlimit']) && $result['countlimit'] == 25 || !isset($result['countlimit']))
                <option value = "25" selected>25</option>
            @else
                <option value = "25">25</option>
            @endif

            @if(isset($result['countlimit']) && $result['countlimit'] == 50)
                <option value = "50" selected>50</option>
            @else
                <option value = "50">50</option>
            @endif

            @if(isset($result['countlimit']) && $result['countlimit'] == 100)
